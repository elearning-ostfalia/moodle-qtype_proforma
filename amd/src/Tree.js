...
* provided that you include the following on ALL copies of the work or portions thereof, including modifications:
...
* on the new code or document such as "This software or document includes material copied from or
* derived from [title and URI of the W3C document]. Copyright © [YEAR] W3C® (MIT, ERCIM, Keio, Beihang)."
...
* ANY PARTICULAR PURPOSE OR THAT THE USE OF THE SOFTWARE OR DOCUMENT WILL NOT INFRINGE
...
* pertaining to the work without specific, written prior permission. Title to copyright
* in this work will at all times remain with copyright holders.
 *
 *   File:   Tree.js
 *
